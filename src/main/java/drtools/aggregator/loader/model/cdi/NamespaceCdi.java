package drtools.aggregator.loader.model.cdi;

import drtools.aggregator.loader.model.Execution;
import drtools.aggregator.loader.model.smell.Smell;
import jakarta.persistence.*;

import java.util.List;

@Entity
@Table(name = NamespaceCdi.TABLE_NAME)
public class NamespaceCdi {
    public static final String TABLE_NAME = "namespace_cdi";
    ...
    @ManyToMany
    @JoinTable(
            name = "namespace_smell_occurence",
            joinColumns = @JoinColumn(name = "namespace_id", referencedColumnName = "id"),
